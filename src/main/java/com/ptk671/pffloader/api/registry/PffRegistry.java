...
public class PffRegistry {
    ...
    public static void registerItem(PffItem pffItem) {
        Registry.register(Registry.ITEM,pffItem.getSettings().getIdentifier().get(),pffItem);
        applySettings(pffItem);
    }
    ...
    public static void registerBlock(PffBlock pffBlock) {
        Registry.register(Registry.BLOCK,pffBlock.getBlockSettings().getIdentifier().get(),pffBlock);
    }
